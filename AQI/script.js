...
const appId = "788d3d69f55b53736b388d2e9c5cc0b5"; // Get your own API Key from https://home.openweathermap.org/api_keys
const link = "https://api.openweathermap.org/data/2.5/air_pollution"; // API end point

const getUserLocation = () => {
    // Set initial latitude and longitude as empty
    let lat = "", lon = "";
